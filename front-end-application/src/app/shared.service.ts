...
export class SharedService {
  ...
  constructor(private http:HttpClient,private dataService:DataSharingService,private jwtHelper: JwtHelperService) { }
...
isCustomerAuthenticated()
  ...
  getCustomerTransactions(val:any)
  {
    ...
    return this.http.post(this.apiUrl+"transactions/getcustomertransactions",custAcc)
  }
